...
import ElectricBorder from '../components/TEST/ElectricBorder';
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      ...
      > */}
        ...
        <div className="w-[700px] h-[500px] mt-4 mb-4 ml-4 mr-4 bg-black rounded-xl shadow-2xl overflow-hidden relative">
          {/* Toggle Button */}
          <button
